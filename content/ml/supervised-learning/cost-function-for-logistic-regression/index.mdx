...
order: 7
description: This section cover the Cost Function for Logistic Regression
---
...
**Results:**
*   Cost for $$b = -3$$: **0.367** (Lower cost ✅)
*   Cost for $$b = -4$$: **0.504** (Higher cost ❌)
